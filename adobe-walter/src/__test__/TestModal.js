...
const TestModal = (props) =>{
    ...
    if(props.isOpen === false){
        ...
        if(props.invoice.status === "Pending" && foo === "OK"){
            return (
                <div>
                    {props.value}
                    <button data-testid="dugme" onClick={() => helperButton()}>Press Me</button>
                </div>
            )
            }else if(props.invoice.status==="Pending" && foo === "NOT"){
                return(
                    <div>
                        Hello World
                    </div>
